...
- Reference Implementation: [`clj-xla.tokenizer.core`](../../src/clj_xla/tokenizer/core.clj).
...
- Reference Implementations: [`clj-xla.sampling`](../../src/clj_xla/sampling.clj) and [`clj-xla.generation.autoregressive`](../../src/clj_xla/generation/autoregressive.clj).
...
- Reference Implementation: [`clj-xla.logic.nn`](../../src/clj_xla/logic/nn.clj).
