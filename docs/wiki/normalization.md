...
* **Clojure Reference**: [`layer-norm`](file:///home/simonpure/src/alpeware/clj-xla/src/clj_xla/nn/norm.clj#L5) in `clj-xla.nn.norm`.
...
* **Clojure Reference**: [`rms-norm`](file:///home/simonpure/src/alpeware/clj-xla/src/clj_xla/nn/norm.clj#L15) in `clj-xla.nn.norm`.
...
* **Clojure Reference**: [`gemma-rms-norm`](file:///home/simonpure/src/alpeware/clj-xla/src/clj_xla/nn/norm.clj#L25) in `clj-xla.nn.norm`.
