...
* **Clojure Reference**: `[:layer-norm ...]` in [`clj-xla.logic.nn`](../../src/clj_xla/logic/nn.clj).
...
* **Clojure Reference**: `[:rms-norm ...]` in [`clj-xla.logic.nn`](../../src/clj_xla/logic/nn.clj).
...
* **Clojure Reference**: `[:gemma-rms-norm ...]` in [`clj-xla.logic.nn`](../../src/clj_xla/logic/nn.clj).
